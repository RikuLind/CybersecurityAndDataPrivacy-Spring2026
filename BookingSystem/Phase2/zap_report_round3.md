...
| --- | --- | --- | --- | --- |
| Info | Informational | http://localhost:8003 | Percentage of responses with status code 2xx | 60 % |
| Info | Informational | http://localhost:8003 | Percentage of responses with status code 3xx | 30 % |
| Info | Exceeded Low | http://localhost:8003 | Percentage of responses with status code 4xx | 8 % |
| Info | Informational | http://localhost:8003 | Percentage of endpoints with content type application/javascript | 15 % |
| Info | Informational | http://localhost:8003 | Percentage of endpoints with content type image/png | 5 % |
| Info | Informational | http://localhost:8003 | Percentage of endpoints with content type text/css | 5 % |
| Info | Informational | http://localhost:8003 | Percentage of endpoints with content type text/html | 25 % |
| Info | Informational | http://localhost:8003 | Percentage of endpoints with content type text/plain | 40 % |
| Info | Informational | http://localhost:8003 | Percentage of endpoints with method GET | 90 % |
| Info | Informational | http://localhost:8003 | Percentage of endpoints with method POST | 10 % |
| Info | Informational | http://localhost:8003 | Count of total endpoints | 20    |
