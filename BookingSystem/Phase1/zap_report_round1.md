...
| Low | Exceeded High | http://localhost:8001 | Percentage of responses with status code 5xx | 57 % |
| Info | Informational | http://localhost:8001 | Percentage of responses with status code 2xx | 26 % |
| Info | Informational | http://localhost:8001 | Percentage of responses with status code 3xx | 4 % |
| Info | Exceeded Low | http://localhost:8001 | Percentage of responses with status code 4xx | 10 % |
...
| Info | Informational | http://localhost:8001 | Percentage of endpoints with content type text/plain | 47 % |
...
| Info | Informational | http://localhost:8001 | Percentage of slow responses | 1 % |
...
* URL: http://localhost:8001/register
  ...
  * Method: `POST`
  * Parameter: `username`
  * Attack: `test@test.com AND 1=1 -- `
  * Evidence: ``
  * Other Info: `The page results were successfully manipulated using the boolean conditions [test@test.com AND 1=1 -- ] and [test@test.com AND 1=2 -- ]
The parameter value being modified was stripped from the HTML output for the purposes of the comparison.
Data was returned for the original parameter.
The vulnerability was detected by successfully restricting the data originally returned, by manipulating the parameter.`
